...
int RHU=83 , RHL=100 ,RK=45 ,RAU=102 ,RAL=91;
...
void write()
{
 pwm.setPWM(15,0,angletopulse(rhu));
...
/*void move3()
{
 r5 move by something
 r1 move by something
 l1 back to normal
 l5 back to normal
}
...
void move4()
{
 l2 return to normal move by something
 l3 return to normal move by something
 l4 return to normal move by something
